...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        //사실 왼쪽인데 RIGHT이라고 잘못씀..ㅠㅠ 왼쪽에 있는 패널 색, 크기 지정
        ...
        jLabel5.setText("jLabel5"); // Jlabel5 = 프로매치 아이콘 이미지역할

        javax.swing.GroupLayout RightLayout = new javax.swing.GroupLayout(Right);
        Right.setLayout(RightLayout);
        RightLayout.setHorizontalGroup(
                RightLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)  // 컴포넌트 왼쪽 정렬
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, RightLayout.createSequentialGroup()
                                .addComponent(jLabel5)  //jLabel5 컴포넌트를 RightLayout에 추가
        ...
        // leftlayout 객체 생성후 left 패널에 적용

        javax.swing.GroupLayout LeftLayout = new javax.swing.GroupLayout(Left);
        Left.setLayout(LeftLayout);
        LeftLayout.setHorizontalGroup(  //수평으로 요소를 배치하기 위한 그룹을 설정하기 위해 setHorizontalGroup 메서드를 사용
        ...
        LeftLayout.setVerticalGroup(    // 수직으로 요소 배치를 위한 그룹 설정
                LeftLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(LeftLayout.createSequentialGroup()
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {  //login 버튼을 클릭했을 때 호출
